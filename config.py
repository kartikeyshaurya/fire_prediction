...
FIRE_PATH = os.path.sep.join(["home", "random_capture_image"])
NON_FIRE_PATH = "spatial_envelope_256x256_static_8outdoorcategories"
CLASSES = ["Non-Fire", "Fire"]
TRAIN_SPLIT = 0.75
TEST_SPLIT = 0.25
...
BATCH_SIZE = 64
NUM_EPOCHS = 50
MODEL_PATH = os.path.sep.join(["model", "fire_detection.model"])
OUTPUT_IMAGE_PATH = os.path.sep.join(["output", "output"])
SAMPLE_SIZE = 50
